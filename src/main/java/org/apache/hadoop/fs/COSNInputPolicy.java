...
public enum COSNInputPolicy {
  ...
  private static final Logger LOG =
      LoggerFactory.getLogger(COSNInputPolicy.class);
  private final String policy;

  COSNInputPolicy(String policy) {
    this.policy = policy;
  }
   ...
   */
  public static COSNInputPolicy getPolicy(String name) {
